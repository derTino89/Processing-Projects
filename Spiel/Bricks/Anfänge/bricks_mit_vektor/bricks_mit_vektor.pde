...
void mouseReleased(){
  gBall.add(new Balls(b.ausgabex(), b.ausgabey() -b.ausgabehoehe()/2)); //Bei jedem Mausklick wird ein neuer Ball in der Fabrik hergestellt und zwar mittig auf dem Balken
}
